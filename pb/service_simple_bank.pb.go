...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x15rpc_create_user.proto\x1a\x15rpc_update_user.proto\x1a\x14rpc_login_user.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xca\x03\n" +
	"\n" +
	...
	"Login user\x1a?Use this API to login user and get access token & refresh token\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_userBk\x92AX\x12V\n" +
	"\x0fSimple Bank API\">\n" +
	"\bNhan Cao\x12\x1bhttps://github.com/nhancaon\x1a\x15ncnhantql@example.com2\x031.1Z\x0esimple-bank/pbb\x06proto3"
